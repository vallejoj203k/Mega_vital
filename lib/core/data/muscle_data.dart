...
const List<MuscleGroup> kMuscleGroups = [
  ...
  // ── POSTERIOR ─────────────────────────────────────────────────
  MuscleGroup(id: 'espalda',  name: 'Espalda',
      nameShort: 'Espalda',
...
const List<ExerciseItem> kAllExercises = [
  ...
  // ── PECHO ─────────────────────────────────────────────────────
  ExerciseItem(id:'pec1', muscleId:'pecho', name:'Press plano en máquina',
      sets:'4', reps:'10-12', restSeconds:75, icon:Icons.fitness_center_rounded,
      difficulty: ExerciseDifficulty.medio,
      tip:'Ajusta el asiento para que los mangos queden a la altura del pecho.'),
  ExerciseItem(id:'pec2', muscleId:'pecho', name:'Press en máquina iso-lateral',
      sets:'4', reps:'10-12', restSeconds:75, icon:Icons.fitness_center_rounded,
      difficulty: ExerciseDifficulty.medio,
      tip:'Trabaja cada lado de forma independiente. Controla el excéntrico.'),
  ExerciseItem(id:'pec3', muscleId:'pecho', name:'Press inclinado en máquina',
      sets:'3', reps:'10-12', restSeconds:75, icon:Icons.fitness_center_rounded,
      difficulty: ExerciseDifficulty.medio,
      tip:'Activa el pectoral superior. Mantén la espalda apoyada en el respaldo.'),
  ExerciseItem(id:'pec4', muscleId:'pecho', name:'Aperturas en polea',
      sets:'3', reps:'12-15', restSeconds:60, icon:Icons.sports_gymnastics_rounded,
      difficulty: ExerciseDifficulty.facil,
      tip:'Ajusta la polea a la altura del pecho. Aprieta en el centro del movimiento.'),
  ExerciseItem(id:'pec5', muscleId:'pecho', name:'Pec Deck',
      sets:'3', reps:'12-15', restSeconds:60, icon:Icons.sports_gymnastics_rounded,
      difficulty: ExerciseDifficulty.facil,
      tip:'Mantén los codos a la altura del pecho. Aprieta al cerrar.'),
  ExerciseItem(id:'pec6', muscleId:'pecho', name:'Press plano con barra',
      sets:'4', reps:'8-10', restSeconds:90, icon:Icons.fitness_center_rounded,
      difficulty: ExerciseDifficulty.medio,
      tip:'Baja la barra despacio. 2 seg de excéntrico.'),
  ExerciseItem(id:'pec7', muscleId:'pecho', name:'Press inclinado con barra',
      sets:'3', reps:'10-12', restSeconds:75, icon:Icons.fitness_center_rounded,
      difficulty: ExerciseDifficulty.medio,
      tip:'Ángulo de 30-45°. Activa el pectoral superior.'),
  ...
  // ── DORSALES ───────────────────────────────────────────────────
  ExerciseItem(id:'dor1', muscleId:'espalda', name:'Dominadas',
      sets:'4', reps:'6-10', restSeconds:90, icon:Icons.sports_gymnastics_rounded,
      difficulty: ExerciseDifficulty.duro,
      tip:'Agarre prono ancho. Baja completamente.'),
  ExerciseItem(id:'dor2', muscleId:'espalda', name:'Jalón al pecho',
      sets:'3', reps:'10-12', restSeconds:75, icon:Icons.sports_gymnastics_rounded,
      difficulty: ExerciseDifficulty.medio),
  ExerciseItem(id:'dor3', muscleId:'espalda', name:'Jalón con agarre supino',
      sets:'3', reps:'10-12', restSeconds:75, icon:Icons.sports_gymnastics_rounded,
      difficulty: ExerciseDifficulty.medio),
  ExerciseItem(id:'dor4', muscleId:'espalda', name:'Pullover con mancuerna',
      sets:'3', reps:'12-15', restSeconds:60, icon:Icons.fitness_center_rounded,
      difficulty: ExerciseDifficulty.facil),
  ExerciseItem(id:'dor5', muscleId:'espalda', name:'Straight Arm Pulldown',
      sets:'3', reps:'12-15', restSeconds:60, icon:Icons.sports_gymnastics_rounded,
      difficulty: ExerciseDifficulty.facil),
  ExerciseItem(id:'dor6', muscleId:'espalda', name:'Remo en máquina',
      sets:'3', reps:'10-12', restSeconds:75, icon:Icons.fitness_center_rounded,
      difficulty: ExerciseDifficulty.medio),
  ...
  // ── LUMBAR ─────────────────────────────────────────────────────
  ExerciseItem(id:'lum1', muscleId:'espalda', name:'Peso muerto convencional',
      sets:'4', reps:'5-6', restSeconds:120, icon:Icons.fitness_center_rounded,
      difficulty: ExerciseDifficulty.duro,
      tip:'Espalda recta. Empuja el suelo. Cabeza neutra.'),
  ExerciseItem(id:'lum2', muscleId:'espalda', name:'Hiperextensiones',
      sets:'3', reps:'12-15', restSeconds:60, icon:Icons.sports_gymnastics_rounded,
      difficulty: ExerciseDifficulty.facil),
  ExerciseItem(id:'lum3', muscleId:'espalda', name:'Buenos días con barra',
      sets:'3', reps:'10-12', restSeconds:75, icon:Icons.fitness_center_rounded,
      difficulty: ExerciseDifficulty.medio),
  ExerciseItem(id:'lum4', muscleId:'espalda', name:'Superman',
      sets:'3', reps:'15-20', restSeconds:45, icon:Icons.sports_gymnastics_rounded,
      difficulty: ExerciseDifficulty.facil),
  ExerciseItem(id:'lum5', muscleId:'espalda', name:'Bird Dog',
      sets:'3', reps:'10 c/lado', restSeconds:45, icon:Icons.sports_gymnastics_rounded,
      difficulty: ExerciseDifficulty.facil,
